...
event_status_t entryIdleState(protimer_t *const mobj, event_t const *const e)
{
    mobj->curr_time = 0;
    mobj->elapsed_time = 0;
    display_time(0);
...
event_status_t exitIdleState(protimer_t *const mobj, event_t const *const e)
{
    display_clear();
    return EVENT_HANDLED;
}
event_status_t IncTimeIdleState(protimer_t *const mobj, event_t const *const e)
{
    mobj->curr_time += 60;
    mobj->active_state = TIME_SET;
    return EVENT_TRANSITION;
}
event_status_t startPauseIdleState(protimer_t *const mobj, event_t const *const e)
{
    mobj->active_state = STAT;
    return EVENT_TRANSITION;
}
event_status_t timeTickIdleState(protimer_t *const mobj, event_t const *const e)
{
...
event_status_t entryTimeSetState(protimer_t *const mobj, event_t const *const e)
{
    display_time(mobj->curr_time);
    return EVENT_HANDLED;
}
event_status_t exitTimeSetState(protimer_t *const mobj, event_t const *const e)
{
    display_clear();
    return EVENT_HANDLED;
}
event_status_t IncTimeTimeSetState(protimer_t *const mobj, event_t const *const e)
{
    mobj->curr_time += 60;
    display_time(mobj->curr_time);
    return EVENT_HANDLED;
}
event static event_status_t protimer_state_handler_TIME_SET(protimer_t *const mobj, event_t const *const e)
{
    switch (e->sig)
    {
    case ENTRY:
